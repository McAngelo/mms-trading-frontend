...
export class CandleStickChartsComponent  implements OnInit {
  ...
  exchangeOneMarketBrief: any = { name: 'Microsoft', symbol: 'MSFT', icon: './assets/media/svg/brand-logos/microsoft-5.svg', avgSell: 82, avgBuy: 64, maxPriceShift: 1, lastTradedPrice: 1 };
